...
rem # foreach ($dev in (Get-CimInstance win32_VideoController | Where-Object {$_.AdapterDACType -like "Internal"})) {
rem #    &"pnputil" /disable-device $dev.PNPDeviceID;
rem # }

rem # https://www.elevenforum.com/members/garlin.5387/
rem # https://www.elevenforum.com/t/pnputil-uninstall-integrated-gpu.33072/#post-559670
