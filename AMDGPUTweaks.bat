...
reg add "HKLM\SYSTEM\CurrentControlSet\Control\Class\%%i" /v "FlipQueueSize_DEF" /t REG_DWORD /d "1" /f
...
reg add "HKLM\SYSTEM\CurrentControlSet\Control\Class\%%i\UMD" /v "FlipQueueSize_NA" /t REG_DWORD /d "1" /f
