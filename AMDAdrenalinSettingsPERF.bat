...
rem # Range: -6 / 11
rem # -6 = HQ / 11 = PERF
rem reg add "HKLM\SYSTEM\CurrentControlSet\Control\Class\%%i" /v "LodAdj" /t REG_SZ /d "11" /f
reg add "HKLM\SYSTEM\CurrentControlSet\Control\Class\%%i" /v "LodAdj_DEF" /t REG_SZ /d "11" /f
reg add "HKLM\SYSTEM\CurrentControlSet\Control\Class\%%i" /v "LodAdj_NA" /t REG_SZ /d "11" /f
rem reg add "HKLM\SYSTEM\CurrentControlSet\Control\Class\%%i\UMD" /v "LodAdj" /t REG_SZ /d "11" /f
reg add "HKLM\SYSTEM\CurrentControlSet\Control\Class\%%i\UMD" /v "LodAdj_DEF" /t REG_SZ /d "11" /f
reg add "HKLM\SYSTEM\CurrentControlSet\Control\Class\%%i\UMD" /v "LodAdj_NA" /t REG_SZ /d "11" /f
