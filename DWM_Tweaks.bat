...
rem # Too low of a value can cause game freezing (default 0x3e8 / 1000)
...
rem # Default 0x2d (45)
reg add "HKLM\SOFTWARE\Microsoft\Windows\Dwm\ExtendedComposition" /v "ExclusiveModeFramerateThresholdPercent" /t REG_DWORD /d "0x2d" /f
