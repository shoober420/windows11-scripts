...
rem # Range: -6 / 11
rem # -6 = HQ / 11 = PERF
reg add "HKLM\SYSTEM\CurrentControlSet\Control\Class\%%i" /v "LodAdj" /t REG_SZ /d "-6" /f
...
reg add "HKLM\SYSTEM\CurrentControlSet\Control\Class\%%i\UMD" /v "LodAdj" /t REG_SZ /d "-6" /f
