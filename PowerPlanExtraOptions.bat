REM !!! NOT RECOMMENDED, DO NOT USE !!!

REM THESE SETTINGS ARE UNNECESSARY TO TWEAK
REM WILL UNHIDE ADDITIONAL POWER PLAN OPTIONS WHICH ARE NOT NEEDED
REM USE POWERPLANULTRA.BAT AND POWERPLANSETTINGS.BAT ONLY
