...
reg add "HKLM\SYSTEM\CurrentControlSet\Services\midisvc" /v "Start" /t REG_DWORD /d "4" /f
...
reg add "HKLM\SYSTEM\CurrentControlSet\Services\shpsvc" /v "Start" /t REG_DWORD /d "4" /f
...
"HKLM\SYSTEM\CurrentControlSet\Services\jhi_service" /v "Start" /t REG_DWORD /d "4" /f
