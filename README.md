...
NOTE: Doing a "Refresh your PC: Local install" will NOT install deleted Windows apps and NOT restore original registry, Cloud install option preferred if cant use USB ISO
